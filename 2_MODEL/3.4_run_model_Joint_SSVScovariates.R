...
rjags_file_name = "4_rjags_model_joint_SSVScovariates.txt" # nom du modele a aller chercher, ecrit ds un fichier txt 

# File main name 
main_name = "JointSSVScovariates"
...
covar.set.M6.sard<-c("nsprat","AMO","NAO","Temp.nov_feb","Zoo.nov_feb")
...
covar.set.g6.sard<-c("nsprat","AMO","NAO","Temp.jun_oct","Zoo.jun_oct")
...
X.M6.list=as.vector(c(X.M1.anch,X.M6.sard))
X.M6=array(X.M6.list,dim=c((n_annee-1),ncov.M.anch,2),dimnames=list(1:(n_annee-1),c("nsprat","AMO","NAO","Temp.nov_feb","Zoo.nov_feb"),c("1","2")))


#g
X.g1.list=as.vector(c(X.g1.anch,X.g1.sard))
X.g1=array(X.g1.list,dim=c((n_annee-1),ncov.g.anch,2),dimnames=list(1:(n_annee-1),c("nsprat","AMO","NAO","Temp.jun/jul_oct","Zoo.jun/jul_oct"),c("1","2")))

X.g2.list=as.vector(c(X.g2.anch,X.g2.sard))
X.g2=array(X.g2.list,dim=c((n_annee-1),ncov.g.anch,2),dimnames=list(1:(n_annee-1),c("nsprat","AMO","NAO","Temp.jun/jul_oct","Zoo.jun/jul_oct"),c("1","2")))

X.g3.list=as.vector(c(X.g3.anch,X.g3.sard))
X.g3=array(X.g3.list,dim=c((n_annee-1),ncov.g.anch,2),dimnames=list(1:(n_annee-1),c("nsprat","AMO","NAO","Temp.jun/jul_oct","Zoo.jun/jul_oct"),c("1","2")))

X.g4.list=as.vector(c(X.g1.anch,X.g4.sard))
X.g4=array(X.g4.list,dim=c((n_annee-1),ncov.g.anch,2),dimnames=list(1:(n_annee-1),c("nsprat","AMO","NAO","Temp.jun/jul_oct","Zoo.jun/jul_oct"),c("1","2")))

X.g5.list=as.vector(c(X.g1.anch,X.g5.sard))
X.g5=array(X.g5.list,dim=c((n_annee-1),ncov.g.anch,2),dimnames=list(1:(n_annee-1),c("nsprat","AMO","NAO","Temp.jun/jul_oct","Zoo.jun/jul_oct"),c("1","2")))

X.g6.list=as.vector(c(X.g1.anch,X.g6.sard))
X.g6=array(X.g6.list,dim=c((n_annee-1),ncov.g.anch,2),dimnames=list(1:(n_annee-1),c("nsprat","AMO","NAO","Temp.jun/jul_oct","Zoo.jun/jul_oct"),c("1","2")))
...
variables_set <- c(
  ...
  # Slopes of regressions, after the selection of intrinsic effects (see Appendix S3 and Appendix S4)
  "alpha_M1",
